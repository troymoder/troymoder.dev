...
<FileTabs client:load files={["pb/ping.proto", "src/main.rs", "build.rs", "Cargo.toml"]}>
```protobuf
::: anchor
proto-example
::: links
...
```toml
[dependencies]
tonic = { version = "0.14", features = ["prost"] }
prost = "0.14"
...
tonic = { version = "0.14", features = ["prost"] }
prost = "0.14"
tinc = { version = "0.2", features = ["prost"] }
serde = "1.0"

[build-dependencies]
tonic-build = "0.14"
tinc-build = { version = "0.2", features = ["prost"] }
```
</FileTabs>
